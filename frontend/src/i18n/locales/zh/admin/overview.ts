export default {
    ...
    users: {
      ...
      governance: {
        seatLabel: '唯一超级管理员席位',
        reason: '治理原因',
        reasonPlaceholder: '说明为何需要执行本次变更',
        reasonHint: '此原因会写入不可变的治理事件。',
        working: '正在执行...',
        failed: '治理操作失败',
        seatUnavailable: '无法读取超级管理员席位，请刷新后重试。',
        deactivateTitle: '停用账户',
        deactivateDescription: '将立即阻断登录、刷新会话和全部现有 API Key。',
        deactivateAction: '停用账户',
        deactivateSuccess: '账户已停用',
        reactivateTitle: '重新启用账户',
        reactivateDescription: '仅恢复账户访问；此前失效的凭据不会自动恢复。',
        reactivateAction: '重新启用账户',
        reactivateSuccess: '账户已重新启用',
        transferTitle: '转移超级管理员席位',
        transferDescription: '席位原子转移后，原持有人与新持有人的现有会话都会失效。',
        transferAction: '转移超级管理员席位',
        transferSuccess: '超级管理员席位已转移'
      },
      form: {
        emailLabel: '邮箱',
