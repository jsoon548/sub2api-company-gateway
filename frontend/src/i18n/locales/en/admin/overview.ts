export default {
    ...
    users: {
      ...
      governance: {
        seatLabel: 'Single Super Admin seat',
        reason: 'Governance reason',
        reasonPlaceholder: 'Record why this change is necessary',
        reasonHint: 'This reason is stored with the immutable governance event.',
        working: 'Applying...',
        failed: 'Governance action failed',
        seatUnavailable: 'The Super Admin seat could not be loaded. Refresh before retrying.',
        deactivateTitle: 'Deactivate account',
        deactivateDescription: 'This immediately blocks login, refresh sessions, and all existing API keys.',
        deactivateAction: 'Deactivate account',
        deactivateSuccess: 'Account deactivated',
        reactivateTitle: 'Reactivate account',
        reactivateDescription: 'This restores account access only. Previously invalidated credentials stay invalid.',
        reactivateAction: 'Reactivate account',
        reactivateSuccess: 'Account reactivated',
        transferTitle: 'Transfer Super Admin seat',
        transferDescription: 'The current and incoming holder sessions are revoked after the atomic seat transfer.',
        transferAction: 'Transfer Super Admin seat',
        transferSuccess: 'Super Admin seat transferred'
      },
      // Settings Dropdowns
