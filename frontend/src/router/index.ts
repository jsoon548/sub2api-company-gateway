...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/admin/audit',
    name: 'AdminAudit',
    redirect: (to) => ({ name: 'AdminGatewayUsage', query: to.query }),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Gateway Reconciliation',
      titleKey: 'admin.gatewayUsage.title',
      descriptionKey: 'admin.gatewayUsage.description'
    }
  },
  {
    path: '/admin/work-session-auto',
    name: 'AdminWorkSessionAuto',
    component: () => import('@/views/admin/WorkSessionAutoView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Work Sessions and Auto',
      titleKey: 'admin.workSession.title',
      descriptionKey: 'admin.workSession.description'
    }
  },
  {
    path: '/admin/gateway-usage',
    name: 'AdminGatewayUsage',
    component: () => import('@/views/admin/GatewayUsageView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Gateway Reconciliation',
