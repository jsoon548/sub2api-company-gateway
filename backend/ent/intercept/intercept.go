...
// The AuditContentPartFunc type is an adapter to allow the use of ordinary function as a Querier.
type AuditContentPartFunc func(context.Context, *ent.AuditContentPartQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AuditContentPartFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AuditContentPartQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AuditContentPartQuery", q)
}

// The TraverseAuditContentPart type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAuditContentPart func(context.Context, *ent.AuditContentPartQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAuditContentPart) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAuditContentPart) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AuditContentPartQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AuditContentPartQuery", q)
}

// The AuditInteractionFunc type is an adapter to allow the use of ordinary function as a Querier.
type AuditInteractionFunc func(context.Context, *ent.AuditInteractionQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AuditInteractionFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AuditInteractionQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AuditInteractionQuery", q)
}

// The TraverseAuditInteraction type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAuditInteraction func(context.Context, *ent.AuditInteractionQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAuditInteraction) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAuditInteraction) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AuditInteractionQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AuditInteractionQuery", q)
}
...
// The AutoCandidatePoolFunc type is an adapter to allow the use of ordinary function as a Querier.
type AutoCandidatePoolFunc func(context.Context, *ent.AutoCandidatePoolQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AutoCandidatePoolFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AutoCandidatePoolQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AutoCandidatePoolQuery", q)
}

// The TraverseAutoCandidatePool type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAutoCandidatePool func(context.Context, *ent.AutoCandidatePoolQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAutoCandidatePool) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAutoCandidatePool) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AutoCandidatePoolQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AutoCandidatePoolQuery", q)
}
...
// The GatewayInferenceRunFunc type is an adapter to allow the use of ordinary function as a Querier.
type GatewayInferenceRunFunc func(context.Context, *ent.GatewayInferenceRunQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f GatewayInferenceRunFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.GatewayInferenceRunQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.GatewayInferenceRunQuery", q)
}

// The TraverseGatewayInferenceRun type is an adapter to allow the use of ordinary function as Traverser.
type TraverseGatewayInferenceRun func(context.Context, *ent.GatewayInferenceRunQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseGatewayInferenceRun) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseGatewayInferenceRun) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.GatewayInferenceRunQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.GatewayInferenceRunQuery", q)
}

// The GovernanceEventFunc type is an adapter to allow the use of ordinary function as a Querier.
type GovernanceEventFunc func(context.Context, *ent.GovernanceEventQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f GovernanceEventFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.GovernanceEventQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.GovernanceEventQuery", q)
}

// The TraverseGovernanceEvent type is an adapter to allow the use of ordinary function as Traverser.
type TraverseGovernanceEvent func(context.Context, *ent.GovernanceEventQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseGovernanceEvent) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseGovernanceEvent) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.GovernanceEventQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.GovernanceEventQuery", q)
}
...
// The RouteDecisionFunc type is an adapter to allow the use of ordinary function as a Querier.
type RouteDecisionFunc func(context.Context, *ent.RouteDecisionQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f RouteDecisionFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.RouteDecisionQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.RouteDecisionQuery", q)
}

// The TraverseRouteDecision type is an adapter to allow the use of ordinary function as Traverser.
type TraverseRouteDecision func(context.Context, *ent.RouteDecisionQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseRouteDecision) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseRouteDecision) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.RouteDecisionQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.RouteDecisionQuery", q)
}
...
// The SuperAdminSeatFunc type is an adapter to allow the use of ordinary function as a Querier.
type SuperAdminSeatFunc func(context.Context, *ent.SuperAdminSeatQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SuperAdminSeatFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SuperAdminSeatQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SuperAdminSeatQuery", q)
}

// The TraverseSuperAdminSeat type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSuperAdminSeat func(context.Context, *ent.SuperAdminSeatQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSuperAdminSeat) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSuperAdminSeat) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SuperAdminSeatQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SuperAdminSeatQuery", q)
}
...
// The WorkSessionFunc type is an adapter to allow the use of ordinary function as a Querier.
type WorkSessionFunc func(context.Context, *ent.WorkSessionQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f WorkSessionFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.WorkSessionQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.WorkSessionQuery", q)
}

// The TraverseWorkSession type is an adapter to allow the use of ordinary function as Traverser.
type TraverseWorkSession func(context.Context, *ent.WorkSessionQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseWorkSession) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseWorkSession) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.WorkSessionQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.WorkSessionQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.AuditContentPartQuery:
		return &query[*ent.AuditContentPartQuery, predicate.AuditContentPart, auditcontentpart.OrderOption]{typ: ent.TypeAuditContentPart, tq: q}, nil
	case *ent.AuditInteractionQuery:
		return &query[*ent.AuditInteractionQuery, predicate.AuditInteraction, auditinteraction.OrderOption]{typ: ent.TypeAuditInteraction, tq: q}, nil
	...
	case *ent.AutoCandidatePoolQuery:
		return &query[*ent.AutoCandidatePoolQuery, predicate.AutoCandidatePool, autocandidatepool.OrderOption]{typ: ent.TypeAutoCandidatePool, tq: q}, nil
	...
	case *ent.GatewayInferenceRunQuery:
		return &query[*ent.GatewayInferenceRunQuery, predicate.GatewayInferenceRun, gatewayinferencerun.OrderOption]{typ: ent.TypeGatewayInferenceRun, tq: q}, nil
	case *ent.GovernanceEventQuery:
		return &query[*ent.GovernanceEventQuery, predicate.GovernanceEvent, governanceevent.OrderOption]{typ: ent.TypeGovernanceEvent, tq: q}, nil
	case *ent.GroupQuery:
	...
	case *ent.RouteDecisionQuery:
		return &query[*ent.RouteDecisionQuery, predicate.RouteDecision, routedecision.OrderOption]{typ: ent.TypeRouteDecision, tq: q}, nil
	...
	case *ent.SuperAdminSeatQuery:
		return &query[*ent.SuperAdminSeatQuery, predicate.SuperAdminSeat, superadminseat.OrderOption]{typ: ent.TypeSuperAdminSeat, tq: q}, nil
	...
	case *ent.WorkSessionQuery:
		return &query[*ent.WorkSessionQuery, predicate.WorkSession, worksession.OrderOption]{typ: ent.TypeWorkSession, tq: q}, nil
	default:
