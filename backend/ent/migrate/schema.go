...
var (
	...
	// AuditContentPartsColumns holds the columns for the "audit_content_parts" table.
	AuditContentPartsColumns = []*schema.Column{
		...
		{Name: "auth_tag", Type: field.TypeBytes},
		{Name: "key_version", Type: field.TypeString, Size: 64},
		{Name: "aad_format_version", Type: field.TypeString, Size: 64},
		{Name: "plaintext_length", Type: field.TypeInt64},
		{Name: "ciphertext_length", Type: field.TypeInt64},
		{Name: "plaintext_sha256", Type: field.TypeBytes},
		{Name: "ciphertext_sha256", Type: field.TypeBytes},
		{Name: "downstream_write_result", Type: field.TypeEnum, Enums: []string{"not_applicable", "pending", "succeeded", "failed", "unknown"}, Default: "not_applicable"},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "interaction_id", Type: field.TypeUUID},
	}
	// AuditContentPartsTable holds the schema information for the "audit_content_parts" table.
	AuditContentPartsTable = &schema.Table{
		Name:       "audit_content_parts",
		Columns:    AuditContentPartsColumns,
		PrimaryKey: []*schema.Column{AuditContentPartsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "audit_content_parts_audit_interactions_content_parts",
				Columns:    []*schema.Column{AuditContentPartsColumns[14]},
				RefColumns: []*schema.Column{AuditInteractionsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "audit_content_parts_interaction_direction_sequence_key",
				Unique:  true,
				Columns: []*schema.Column{AuditContentPartsColumns[14], AuditContentPartsColumns[1], AuditContentPartsColumns[2]},
			},
			{
				Name:    "audit_content_parts_interaction_created_idx",
				Unique:  false,
				Columns: []*schema.Column{AuditContentPartsColumns[14], AuditContentPartsColumns[13]},
			},
		},
	}
	// AuditInteractionsColumns holds the columns for the "audit_interactions" table.
	AuditInteractionsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "gateway_request_id", Type: field.TypeUUID, Unique: true},
		{Name: "work_session_id", Type: field.TypeUUID, Nullable: true},
		{Name: "subject_user_id", Type: field.TypeInt64, Nullable: true},
		{Name: "subject_email_snapshot", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "api_key_id", Type: field.TypeInt64, Nullable: true},
		{Name: "api_key_fingerprint", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "profile_version", Type: field.TypeString, Size: 64},
		{Name: "protocol", Type: field.TypeEnum, Enums: []string{"anthropic", "openai"}},
		{Name: "endpoint", Type: field.TypeString, Size: 512},
		{Name: "method", Type: field.TypeString, Size: 16},
		{Name: "transport", Type: field.TypeEnum, Enums: []string{"http", "sse"}},
		{Name: "requested_model", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "resolved_model", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "request_outcome", Type: field.TypeEnum, Enums: []string{"processing", "rejected_pre_upstream", "completed", "upstream_failed", "interrupted"}, Default: "processing"},
		{Name: "request_outcome_version", Type: field.TypeInt64, Default: 0},
		{Name: "content_state", Type: field.TypeEnum, Enums: []string{"recording", "complete", "incomplete", "expired"}, Default: "recording"},
		{Name: "content_state_version", Type: field.TypeInt64, Default: 0},
		{Name: "downstream_status", Type: field.TypeInt16, Nullable: true},
		{Name: "downstream_write_result", Type: field.TypeEnum, Enums: []string{"not_applicable", "pending", "succeeded", "failed", "unknown"}, Default: "not_applicable"},
		...
		{Name: "request_sha256", Type: field.TypeBytes, Nullable: true},
		{Name: "response_sha256", Type: field.TypeBytes, Nullable: true},
		{Name: "request_part_count", Type: field.TypeInt, Default: 0},
		{Name: "response_part_count", Type: field.TypeInt, Default: 0},
		{Name: "safe_error_summary", Type: field.TypeString, Nullable: true, Size: 512},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// AuditInteractionsTable holds the schema information for the "audit_interactions" table.
	AuditInteractionsTable = &schema.Table{
		Name:       "audit_interactions",
		Columns:    AuditInteractionsColumns,
		PrimaryKey: []*schema.Column{AuditInteractionsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "audit_interactions_subject_admitted_idx",
				Unique:  false,
				Columns: []*schema.Column{AuditInteractionsColumns[3], AuditInteractionsColumns[20]},
				Annotation: &entsql.IndexAnnotation{
					Where: "subject_user_id IS NOT NULL",
				},
			},
			{
				Name:    "audit_interactions_outcome_state_activity_idx",
				Unique:  false,
				Columns: []*schema.Column{AuditInteractionsColumns[14], AuditInteractionsColumns[16], AuditInteractionsColumns[23]},
			},
			{
				Name:    "audit_interactions_expires_idx",
				Unique:  false,
				Columns: []*schema.Column{AuditInteractionsColumns[22]},
			},
			{
				Name:    "audit_interactions_work_session_idx",
				Unique:  false,
				Columns: []*schema.Column{AuditInteractionsColumns[2], AuditInteractionsColumns[20]},
				Annotation: &entsql.IndexAnnotation{
	...
	// AutoCandidatePoolsColumns holds the columns for the "auto_candidate_pools" table.
	AutoCandidatePoolsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "generation", Type: field.TypeInt64},
		{Name: "tier", Type: field.TypeEnum, Enums: []string{"economy", "general", "advanced"}},
		{Name: "position", Type: field.TypeInt},
		{Name: "catalog_entry_id", Type: field.TypeUUID},
		{Name: "valid_from", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "valid_until", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// AutoCandidatePoolsTable holds the schema information for the "auto_candidate_pools" table.
	AutoCandidatePoolsTable = &schema.Table{
		Name:       "auto_candidate_pools",
		Columns:    AutoCandidatePoolsColumns,
		PrimaryKey: []*schema.Column{AutoCandidatePoolsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "auto_candidate_pool_position_key",
				Unique:  true,
				Columns: []*schema.Column{AutoCandidatePoolsColumns[1], AutoCandidatePoolsColumns[2], AutoCandidatePoolsColumns[3]},
			},
			{
				Name:    "auto_candidate_pool_entry_key",
				Unique:  true,
				Columns: []*schema.Column{AutoCandidatePoolsColumns[1], AutoCandidatePoolsColumns[2], AutoCandidatePoolsColumns[4]},
			},
		},
	}
	...
	// GatewayInferenceRunsColumns holds the columns for the "gateway_inference_runs" table.
	GatewayInferenceRunsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "purpose", Type: field.TypeString, Size: 64},
		{Name: "profile", Type: field.TypeString, Size: 64},
		{Name: "backend", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeString, Size: 100},
		{Name: "model", Type: field.TypeString, Size: 100},
		{Name: "prompt_version", Type: field.TypeString, Size: 64},
		{Name: "schema_version", Type: field.TypeString, Size: 64},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"completed", "invalid_request", "unavailable", "timeout", "canceled", "rejected", "rate_limited", "provider_error", "refused", "empty_response", "invalid_response", "response_too_large", "usage_missing"}},
		{Name: "provider_request_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "input_units", Type: field.TypeInt64, Nullable: true},
		{Name: "output_units", Type: field.TypeInt64, Nullable: true},
		{Name: "latency_ms", Type: field.TypeInt64, Default: 0},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// GatewayInferenceRunsTable holds the schema information for the "gateway_inference_runs" table.
	GatewayInferenceRunsTable = &schema.Table{
		Name:       "gateway_inference_runs",
		Columns:    GatewayInferenceRunsColumns,
		PrimaryKey: []*schema.Column{GatewayInferenceRunsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "gateway_inference_runs_profile_created_idx",
				Unique:  false,
				Columns: []*schema.Column{GatewayInferenceRunsColumns[2], GatewayInferenceRunsColumns[13]},
			},
			{
				Name:    "gateway_inference_runs_status_created_idx",
				Unique:  false,
				Columns: []*schema.Column{GatewayInferenceRunsColumns[8], GatewayInferenceRunsColumns[13]},
			},
		},
	}
	// GovernanceEventsColumns holds the columns for the "governance_events" table.
	GovernanceEventsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "operation_id", Type: field.TypeUUID},
		{Name: "event_sequence", Type: field.TypeInt},
		{Name: "actor_kind", Type: field.TypeEnum, Enums: []string{"named_admin", "deployment_operator", "system"}, SchemaType: map[string]string{"postgres": "governance_actor_kind"}},
		{Name: "deployment_operator_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "target_kind", Type: field.TypeString, Size: 64},
		{Name: "target_id", Type: field.TypeString, Size: 255},
		{Name: "action", Type: field.TypeString, Size: 64},
		{Name: "result", Type: field.TypeEnum, Enums: []string{"started", "succeeded", "failed", "rejected", "reconciled"}, SchemaType: map[string]string{"postgres": "governance_result"}},
		{Name: "reason", Type: field.TypeString, Nullable: true, Size: 512},
		{Name: "before_summary", Type: field.TypeJSON, Nullable: true},
		{Name: "after_summary", Type: field.TypeJSON, Nullable: true},
		{Name: "recovery_nonce_fingerprint", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "gateway_request_id", Type: field.TypeString, Nullable: true, Size: 36},
		{Name: "safe_error_summary", Type: field.TypeString, Nullable: true, Size: 512},
	...
	// GovernanceEventsTable holds the schema information for the "governance_events" table.
	GovernanceEventsTable = &schema.Table{
		Name:       "governance_events",
		Columns:    GovernanceEventsColumns,
		PrimaryKey: []*schema.Column{GovernanceEventsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "governance_events_users_actor",
				Columns:    []*schema.Column{GovernanceEventsColumns[16]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.Restrict,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "governanceevent_operation_id_event_sequence",
				Unique:  true,
				Columns: []*schema.Column{GovernanceEventsColumns[1], GovernanceEventsColumns[2]},
			},
			{
				Name:    "governanceevent_recovery_nonce_fingerprint",
				Unique:  true,
				Columns: []*schema.Column{GovernanceEventsColumns[12]},
			},
			{
				Name:    "governance_target_time_idx",
				Unique:  false,
				Columns: []*schema.Column{GovernanceEventsColumns[5], GovernanceEventsColumns[6], GovernanceEventsColumns[15]},
			},
			{
				Name:    "governance_actor_time_idx",
				Unique:  false,
				Columns: []*schema.Column{GovernanceEventsColumns[16], GovernanceEventsColumns[15]},
				Annotation: &entsql.IndexAnnotation{
	...
	ModelCatalogEntriesColumns = []*schema.Column{
		...
		{Name: "provider_model", Type: field.TypeString, Size: 100},
		{Name: "tier", Type: field.TypeEnum, Enums: []string{"economy", "general", "advanced"}},
		{Name: "capabilities", Type: field.TypeJSON},
		{Name: "valid_from", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "valid_until", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "emergency_disabled", Type: field.TypeBool, Default: false},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	...
	ModelCatalogEntriesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "model_catalog_generation_model_key",
				Unique:  true,
				Columns: []*schema.Column{ModelCatalogEntriesColumns[1], ModelCatalogEntriesColumns[2]},
			},
			{
				Name:    "model_catalog_generation_tier_idx",
				Unique:  false,
				Columns: []*schema.Column{ModelCatalogEntriesColumns[1], ModelCatalogEntriesColumns[4], ModelCatalogEntriesColumns[2]},
			},
			{
				Name:    "model_catalog_emergency_idx",
				Unique:  false,
				Columns: []*schema.Column{ModelCatalogEntriesColumns[2]},
				Annotation: &entsql.IndexAnnotation{
	...
	// RouteDecisionsColumns holds the columns for the "route_decisions" table.
	RouteDecisionsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "gateway_request_id", Type: field.TypeUUID, Unique: true},
		{Name: "work_session_id", Type: field.TypeUUID},
		{Name: "employee_user_id", Type: field.TypeInt64},
		{Name: "profile_version", Type: field.TypeString, Size: 64},
		{Name: "config_version", Type: field.TypeInt64},
		{Name: "required_capabilities", Type: field.TypeJSON},
		{Name: "task_complexity", Type: field.TypeEnum, Enums: []string{"simple", "general", "complex"}},
		{Name: "certainty", Type: field.TypeEnum, Enums: []string{"deterministic", "decisive", "uncertain"}},
		{Name: "explanation", Type: field.TypeString, Size: 1024},
		{Name: "decision_source", Type: field.TypeEnum, Enums: []string{"rule", "classifier", "fallback"}},
		{Name: "rule_version", Type: field.TypeString, Size: 64},
		{Name: "classifier_run_id", Type: field.TypeUUID, Unique: true, Nullable: true},
		{Name: "classifier_version", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "classifier_status", Type: field.TypeEnum, Enums: []string{"not_called", "completed", "timeout", "invalid", "unavailable"}},
		{Name: "classifier_latency_ms", Type: field.TypeInt64, Default: 0},
		{Name: "requested_tier", Type: field.TypeEnum, Enums: []string{"economy", "general", "advanced"}},
		{Name: "effective_tier", Type: field.TypeEnum, Enums: []string{"economy", "general", "advanced"}},
		{Name: "candidate_pool", Type: field.TypeJSON},
		{Name: "actual_logical_model", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "actual_provider_model", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "change_reason", Type: field.TypeString, Size: 64},
		{Name: "technical_retry_count", Type: field.TypeInt16, Default: 0},
		{Name: "technical_retry_reason", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "decision_result", Type: field.TypeEnum, Enums: []string{"selected", "unavailable", "failed"}},
		{Name: "routing_latency_ms", Type: field.TypeInt64, Default: 0},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// RouteDecisionsTable holds the schema information for the "route_decisions" table.
	RouteDecisionsTable = &schema.Table{
		Name:       "route_decisions",
		Columns:    RouteDecisionsColumns,
		PrimaryKey: []*schema.Column{RouteDecisionsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "route_decisions_session_created_idx",
				Unique:  false,
				Columns: []*schema.Column{RouteDecisionsColumns[2], RouteDecisionsColumns[26]},
			},
			{
				Name:    "route_decisions_employee_created_idx",
				Unique:  false,
				Columns: []*schema.Column{RouteDecisionsColumns[3], RouteDecisionsColumns[26]},
			},
			{
				Name:    "route_decisions_classifier_latency_idx",
				Unique:  false,
				Columns: []*schema.Column{RouteDecisionsColumns[14], RouteDecisionsColumns[15]},
				Annotation: &entsql.IndexAnnotation{
	...
	// SuperAdminSeatColumns holds the columns for the "super_admin_seat" table.
	SuperAdminSeatColumns = []*schema.Column{
		{Name: "singleton_id", Type: field.TypeInt16},
		{Name: "version", Type: field.TypeInt64, Default: 1},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "user_id", Type: field.TypeInt64},
	}
	// SuperAdminSeatTable holds the schema information for the "super_admin_seat" table.
	SuperAdminSeatTable = &schema.Table{
		Name:       "super_admin_seat",
		Columns:    SuperAdminSeatColumns,
		PrimaryKey: []*schema.Column{SuperAdminSeatColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "super_admin_seat_users_user",
				Columns:    []*schema.Column{SuperAdminSeatColumns[3]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.Restrict,
			},
		},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "gateway_request_id", Type: field.TypeUUID, Nullable: true},
		{Name: "model", Type: field.TypeString, Size: 100},
		{Name: "requested_model", Type: field.TypeString, Nullable: true, Size: 100},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usage_logs_gateway_request_id_idx",
				Unique:  false,
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "session_version", Type: field.TypeInt64, Default: 0},
	...
	// WorkSessionsColumns holds the columns for the "work_sessions" table.
	WorkSessionsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "tenant_id", Type: field.TypeString, Size: 128},
		{Name: "employee_user_id", Type: field.TypeInt64},
		{Name: "profile_version", Type: field.TypeString, Size: 64},
		{Name: "signal_source", Type: field.TypeString, Size: 64},
		{Name: "signal_status", Type: field.TypeEnum, Enums: []string{"verified", "missing", "malformed"}},
		{Name: "session_key_hmac", Type: field.TypeBytes, Nullable: true},
		{Name: "hmac_key_version", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "reliability", Type: field.TypeEnum, Enums: []string{"reliable", "unreliable"}},
		{Name: "routing_mode", Type: field.TypeEnum, Enums: []string{"explicit", "auto"}},
		{Name: "config_version", Type: field.TypeInt64},
		{Name: "analysis_eligible", Type: field.TypeBool, Default: false},
		{Name: "quota_grace_eligible", Type: field.TypeBool, Default: false},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"active", "request_scoped"}},
		{Name: "selected_logical_model", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "selected_tier", Type: field.TypeEnum, Nullable: true, Enums: []string{"economy", "general", "advanced"}},
		{Name: "selected_complexity", Type: field.TypeEnum, Nullable: true, Enums: []string{"simple", "general", "complex"}},
		{Name: "required_capabilities", Type: field.TypeJSON},
		{Name: "routing_version", Type: field.TypeInt64, Default: 0},
		{Name: "first_gateway_request_id", Type: field.TypeUUID},
		{Name: "last_gateway_request_id", Type: field.TypeUUID},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "last_activity_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	...
	WorkSessionsTable = &schema.Table{
		Name:       "work_sessions",
		Columns:    WorkSessionsColumns,
		PrimaryKey: []*schema.Column{WorkSessionsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "work_sessions_reliable_identity_key",
				Unique:  true,
				Columns: []*schema.Column{WorkSessionsColumns[1], WorkSessionsColumns[2], WorkSessionsColumns[3], WorkSessionsColumns[4], WorkSessionsColumns[7], WorkSessionsColumns[6]},
				Annotation: &entsql.IndexAnnotation{
					Where: "reliability = 'reliable'",
				},
			},
			{
				Name:    "work_sessions_employee_activity_idx",
				Unique:  false,
				Columns: []*schema.Column{WorkSessionsColumns[2], WorkSessionsColumns[22]},
			},
			{
				Name:    "work_sessions_config_version_idx",
				Unique:  false,
				Columns: []*schema.Column{WorkSessionsColumns[10], WorkSessionsColumns[21]},
			},
		},
	}
	...
	Tables = []*schema.Table{
		...
		AuditContentPartsTable,
		AuditInteractionsTable,
		AuthIdentitiesTable,
		AuthIdentityChannelsTable,
		AutoCandidatePoolsTable,
...
func init() {
	...
	AuditContentPartsTable.ForeignKeys[0].RefTable = AuditInteractionsTable
	AuditContentPartsTable.Annotation = &entsql.Annotation{
		Table: "audit_content_parts",
	}
	AuditInteractionsTable.Annotation = &entsql.Annotation{
	...
	AutoCandidatePoolsTable.Annotation = &entsql.Annotation{
	...
	GatewayInferenceRunsTable.Annotation = &entsql.Annotation{
		Table: "gateway_inference_runs",
	}
	GovernanceEventsTable.ForeignKeys[0].RefTable = UsersTable
	GovernanceEventsTable.Annotation = &entsql.Annotation{
	...
	RouteDecisionsTable.Annotation = &entsql.Annotation{
	...
	SuperAdminSeatTable.ForeignKeys[0].RefTable = UsersTable
	SuperAdminSeatTable.Annotation = &entsql.Annotation{
		Table: "super_admin_seat",
	}
	SuperAdminSeatTable.Annotation.Checks = map[string]string{
	...
	WorkSessionsTable.Annotation = &entsql.Annotation{
		Table: "work_sessions",
	}
}
