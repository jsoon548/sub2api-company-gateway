...
// The AuditContentPartFunc type is an adapter to allow the use of ordinary
// function as AuditContentPart mutator.
type AuditContentPartFunc func(context.Context, *ent.AuditContentPartMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AuditContentPartFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AuditContentPartMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AuditContentPartMutation", m)
}

// The AuditInteractionFunc type is an adapter to allow the use of ordinary
// function as AuditInteraction mutator.
type AuditInteractionFunc func(context.Context, *ent.AuditInteractionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AuditInteractionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AuditInteractionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AuditInteractionMutation", m)
}
...
// The AutoCandidatePoolFunc type is an adapter to allow the use of ordinary
// function as AutoCandidatePool mutator.
type AutoCandidatePoolFunc func(context.Context, *ent.AutoCandidatePoolMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AutoCandidatePoolFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AutoCandidatePoolMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AutoCandidatePoolMutation", m)
}
...
// The GatewayInferenceRunFunc type is an adapter to allow the use of ordinary
// function as GatewayInferenceRun mutator.
type GatewayInferenceRunFunc func(context.Context, *ent.GatewayInferenceRunMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GatewayInferenceRunFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GatewayInferenceRunMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GatewayInferenceRunMutation", m)
}

// The GovernanceEventFunc type is an adapter to allow the use of ordinary
// function as GovernanceEvent mutator.
type GovernanceEventFunc func(context.Context, *ent.GovernanceEventMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GovernanceEventFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GovernanceEventMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GovernanceEventMutation", m)
}
...
// The RouteDecisionFunc type is an adapter to allow the use of ordinary
// function as RouteDecision mutator.
type RouteDecisionFunc func(context.Context, *ent.RouteDecisionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RouteDecisionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RouteDecisionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RouteDecisionMutation", m)
}
...
// The SuperAdminSeatFunc type is an adapter to allow the use of ordinary
// function as SuperAdminSeat mutator.
type SuperAdminSeatFunc func(context.Context, *ent.SuperAdminSeatMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SuperAdminSeatFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SuperAdminSeatMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SuperAdminSeatMutation", m)
}
...
// The WorkSessionFunc type is an adapter to allow the use of ordinary
// function as WorkSession mutator.
type WorkSessionFunc func(context.Context, *ent.WorkSessionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WorkSessionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WorkSessionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WorkSessionMutation", m)
}
