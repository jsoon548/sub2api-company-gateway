...
func (_u *UsageLogUpdate) SetGatewayRequestID(v uuid.UUID) *UsageLogUpdate {
...
func (_u *UsageLogUpdate) SetNillableGatewayRequestID(v *uuid.UUID) *UsageLogUpdate {
	if v != nil {
...
func (_u *UsageLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.GatewayRequestID(); ok {
		_spec.SetField(usagelog.FieldGatewayRequestID, field.TypeUUID, value)
	}
	if _u.mutation.GatewayRequestIDCleared() {
		_spec.ClearField(usagelog.FieldGatewayRequestID, field.TypeUUID)
	}
...
// SetGatewayRequestID sets the "gateway_request_id" field.
func (_u *UsageLogUpdateOne) SetGatewayRequestID(v uuid.UUID) *UsageLogUpdateOne {
	_u.mutation.SetGatewayRequestID(v)
	return _u
}

// SetNillableGatewayRequestID sets the "gateway_request_id" field if the given value is not nil.
func (_u *UsageLogUpdateOne) SetNillableGatewayRequestID(v *uuid.UUID) *UsageLogUpdateOne {
	if v != nil {
		_u.SetGatewayRequestID(*v)
	}
	return _u
