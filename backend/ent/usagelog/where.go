...
func GatewayRequestID(v uuid.UUID) predicate.UsageLog {
...
func GatewayRequestIDEQ(v uuid.UUID) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEQ(FieldGatewayRequestID, v))
}

// GatewayRequestIDNEQ applies the NEQ predicate on the "gateway_request_id" field.
func GatewayRequestIDNEQ(v uuid.UUID) predicate.UsageLog {
...
func GatewayRequestIDIn(vs ...uuid.UUID) predicate.UsageLog {
...
func GatewayRequestIDNotIn(vs ...uuid.UUID) predicate.UsageLog {
...
func GatewayRequestIDGT(v uuid.UUID) predicate.UsageLog {
...
func GatewayRequestIDGTE(v uuid.UUID) predicate.UsageLog {
...
func GatewayRequestIDLT(v uuid.UUID) predicate.UsageLog {
...
func GatewayRequestIDLTE(v uuid.UUID) predicate.UsageLog {
