...
func init() {
	...
	auditcontentpartFields := schema.AuditContentPart{}.Fields()
	_ = auditcontentpartFields
	// auditcontentpartDescKeyVersion is the schema descriptor for key_version field.
	auditcontentpartDescKeyVersion := auditcontentpartFields[7].Descriptor()
	// auditcontentpart.KeyVersionValidator is a validator for the "key_version" field. It is called by the builders before save.
	auditcontentpart.KeyVersionValidator = auditcontentpartDescKeyVersion.Validators[0].(func(string) error)
	// auditcontentpartDescAadFormatVersion is the schema descriptor for aad_format_version field.
	auditcontentpartDescAadFormatVersion := auditcontentpartFields[8].Descriptor()
	// auditcontentpart.AadFormatVersionValidator is a validator for the "aad_format_version" field. It is called by the builders before save.
	auditcontentpart.AadFormatVersionValidator = auditcontentpartDescAadFormatVersion.Validators[0].(func(string) error)
	// auditcontentpartDescCreatedAt is the schema descriptor for created_at field.
	auditcontentpartDescCreatedAt := auditcontentpartFields[14].Descriptor()
	// auditcontentpart.DefaultCreatedAt holds the default value on creation for the created_at field.
	auditcontentpart.DefaultCreatedAt = auditcontentpartDescCreatedAt.Default.(func() time.Time)
	// auditcontentpartDescID is the schema descriptor for id field.
	auditcontentpartDescID := auditcontentpartFields[0].Descriptor()
	// auditcontentpart.DefaultID holds the default value on creation for the id field.
	auditcontentpart.DefaultID = auditcontentpartDescID.Default.(func() uuid.UUID)
	auditinteractionFields := schema.AuditInteraction{}.Fields()
	_ = auditinteractionFields
	// auditinteractionDescSubjectEmailSnapshot is the schema descriptor for subject_email_snapshot field.
	auditinteractionDescSubjectEmailSnapshot := auditinteractionFields[4].Descriptor()
	// auditinteraction.SubjectEmailSnapshotValidator is a validator for the "subject_email_snapshot" field. It is called by the builders before save.
	auditinteraction.SubjectEmailSnapshotValidator = auditinteractionDescSubjectEmailSnapshot.Validators[0].(func(string) error)
	// auditinteractionDescAPIKeyFingerprint is the schema descriptor for api_key_fingerprint field.
	auditinteractionDescAPIKeyFingerprint := auditinteractionFields[6].Descriptor()
	// auditinteraction.APIKeyFingerprintValidator is a validator for the "api_key_fingerprint" field. It is called by the builders before save.
	auditinteraction.APIKeyFingerprintValidator = auditinteractionDescAPIKeyFingerprint.Validators[0].(func(string) error)
	// auditinteractionDescProfileVersion is the schema descriptor for profile_version field.
	auditinteractionDescProfileVersion := auditinteractionFields[7].Descriptor()
	// auditinteraction.ProfileVersionValidator is a validator for the "profile_version" field. It is called by the builders before save.
	auditinteraction.ProfileVersionValidator = auditinteractionDescProfileVersion.Validators[0].(func(string) error)
	// auditinteractionDescEndpoint is the schema descriptor for endpoint field.
	auditinteractionDescEndpoint := auditinteractionFields[9].Descriptor()
	// auditinteraction.EndpointValidator is a validator for the "endpoint" field. It is called by the builders before save.
	auditinteraction.EndpointValidator = auditinteractionDescEndpoint.Validators[0].(func(string) error)
	// auditinteractionDescMethod is the schema descriptor for method field.
	auditinteractionDescMethod := auditinteractionFields[10].Descriptor()
	// auditinteraction.MethodValidator is a validator for the "method" field. It is called by the builders before save.
	auditinteraction.MethodValidator = auditinteractionDescMethod.Validators[0].(func(string) error)
	// auditinteractionDescRequestedModel is the schema descriptor for requested_model field.
	auditinteractionDescRequestedModel := auditinteractionFields[12].Descriptor()
	// auditinteraction.RequestedModelValidator is a validator for the "requested_model" field. It is called by the builders before save.
	auditinteraction.RequestedModelValidator = auditinteractionDescRequestedModel.Validators[0].(func(string) error)
	// auditinteractionDescResolvedModel is the schema descriptor for resolved_model field.
	auditinteractionDescResolvedModel := auditinteractionFields[13].Descriptor()
	// auditinteraction.ResolvedModelValidator is a validator for the "resolved_model" field. It is called by the builders before save.
	auditinteraction.ResolvedModelValidator = auditinteractionDescResolvedModel.Validators[0].(func(string) error)
	// auditinteractionDescRequestOutcomeVersion is the schema descriptor for request_outcome_version field.
	auditinteractionDescRequestOutcomeVersion := auditinteractionFields[15].Descriptor()
	// auditinteraction.DefaultRequestOutcomeVersion holds the default value on creation for the request_outcome_version field.
	auditinteraction.DefaultRequestOutcomeVersion = auditinteractionDescRequestOutcomeVersion.Default.(int64)
	// auditinteractionDescContentStateVersion is the schema descriptor for content_state_version field.
	auditinteractionDescContentStateVersion := auditinteractionFields[17].Descriptor()
	// auditinteraction.DefaultContentStateVersion holds the default value on creation for the content_state_version field.
	auditinteraction.DefaultContentStateVersion = auditinteractionDescContentStateVersion.Default.(int64)
	// auditinteractionDescRequestPartCount is the schema descriptor for request_part_count field.
	auditinteractionDescRequestPartCount := auditinteractionFields[26].Descriptor()
	// auditinteraction.DefaultRequestPartCount holds the default value on creation for the request_part_count field.
	auditinteraction.DefaultRequestPartCount = auditinteractionDescRequestPartCount.Default.(int)
	// auditinteractionDescResponsePartCount is the schema descriptor for response_part_count field.
	auditinteractionDescResponsePartCount := auditinteractionFields[27].Descriptor()
	// auditinteraction.DefaultResponsePartCount holds the default value on creation for the response_part_count field.
	auditinteraction.DefaultResponsePartCount = auditinteractionDescResponsePartCount.Default.(int)
	// auditinteractionDescSafeErrorSummary is the schema descriptor for safe_error_summary field.
	auditinteractionDescSafeErrorSummary := auditinteractionFields[28].Descriptor()
	// auditinteraction.SafeErrorSummaryValidator is a validator for the "safe_error_summary" field. It is called by the builders before save.
	auditinteraction.SafeErrorSummaryValidator = auditinteractionDescSafeErrorSummary.Validators[0].(func(string) error)
	// auditinteractionDescCreatedAt is the schema descriptor for created_at field.
	auditinteractionDescCreatedAt := auditinteractionFields[29].Descriptor()
	// auditinteraction.DefaultCreatedAt holds the default value on creation for the created_at field.
	auditinteraction.DefaultCreatedAt = auditinteractionDescCreatedAt.Default.(func() time.Time)
	// auditinteractionDescUpdatedAt is the schema descriptor for updated_at field.
	auditinteractionDescUpdatedAt := auditinteractionFields[30].Descriptor()
	// auditinteraction.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	auditinteraction.DefaultUpdatedAt = auditinteractionDescUpdatedAt.Default.(func() time.Time)
	// auditinteraction.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	auditinteraction.UpdateDefaultUpdatedAt = auditinteractionDescUpdatedAt.UpdateDefault.(func() time.Time)
	// auditinteractionDescID is the schema descriptor for id field.
	auditinteractionDescID := auditinteractionFields[0].Descriptor()
	// auditinteraction.DefaultID holds the default value on creation for the id field.
	auditinteraction.DefaultID = auditinteractionDescID.Default.(func() uuid.UUID)
	...
	autocandidatepoolFields := schema.AutoCandidatePool{}.Fields()
	_ = autocandidatepoolFields
	// autocandidatepoolDescPosition is the schema descriptor for position field.
	autocandidatepoolDescPosition := autocandidatepoolFields[3].Descriptor()
	// autocandidatepool.PositionValidator is a validator for the "position" field. It is called by the builders before save.
	autocandidatepool.PositionValidator = autocandidatepoolDescPosition.Validators[0].(func(int) error)
	// autocandidatepoolDescCreatedAt is the schema descriptor for created_at field.
	autocandidatepoolDescCreatedAt := autocandidatepoolFields[7].Descriptor()
	// autocandidatepool.DefaultCreatedAt holds the default value on creation for the created_at field.
	autocandidatepool.DefaultCreatedAt = autocandidatepoolDescCreatedAt.Default.(func() time.Time)
	// autocandidatepoolDescID is the schema descriptor for id field.
	autocandidatepoolDescID := autocandidatepoolFields[0].Descriptor()
	// autocandidatepool.DefaultID holds the default value on creation for the id field.
	autocandidatepool.DefaultID = autocandidatepoolDescID.Default.(func() uuid.UUID)
	...
	gatewayinferencerunFields := schema.GatewayInferenceRun{}.Fields()
	_ = gatewayinferencerunFields
	// gatewayinferencerunDescPurpose is the schema descriptor for purpose field.
	gatewayinferencerunDescPurpose := gatewayinferencerunFields[1].Descriptor()
	// gatewayinferencerun.PurposeValidator is a validator for the "purpose" field. It is called by the builders before save.
	gatewayinferencerun.PurposeValidator = func() func(string) error {
		validators := gatewayinferencerunDescPurpose.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// gatewayinferencerunDescProfile is the schema descriptor for profile field.
	gatewayinferencerunDescProfile := gatewayinferencerunFields[2].Descriptor()
	// gatewayinferencerun.ProfileValidator is a validator for the "profile" field. It is called by the builders before save.
	gatewayinferencerun.ProfileValidator = func() func(string) error {
		validators := gatewayinferencerunDescProfile.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// gatewayinferencerunDescBackend is the schema descriptor for backend field.
	gatewayinferencerunDescBackend := gatewayinferencerunFields[3].Descriptor()
	// gatewayinferencerun.BackendValidator is a validator for the "backend" field. It is called by the builders before save.
	gatewayinferencerun.BackendValidator = func() func(string) error {
		validators := gatewayinferencerunDescBackend.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(backend string) error {
			for _, fn := range fns {
	...
	// gatewayinferencerunDescProvider is the schema descriptor for provider field.
	gatewayinferencerunDescProvider := gatewayinferencerunFields[4].Descriptor()
	// gatewayinferencerun.ProviderValidator is a validator for the "provider" field. It is called by the builders before save.
	gatewayinferencerun.ProviderValidator = func() func(string) error {
		validators := gatewayinferencerunDescProvider.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// gatewayinferencerunDescModel is the schema descriptor for model field.
	gatewayinferencerunDescModel := gatewayinferencerunFields[5].Descriptor()
	// gatewayinferencerun.ModelValidator is a validator for the "model" field. It is called by the builders before save.
	gatewayinferencerun.ModelValidator = func() func(string) error {
		validators := gatewayinferencerunDescModel.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// gatewayinferencerunDescPromptVersion is the schema descriptor for prompt_version field.
	gatewayinferencerunDescPromptVersion := gatewayinferencerunFields[6].Descriptor()
	// gatewayinferencerun.PromptVersionValidator is a validator for the "prompt_version" field. It is called by the builders before save.
	gatewayinferencerun.PromptVersionValidator = func() func(string) error {
		validators := gatewayinferencerunDescPromptVersion.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// gatewayinferencerunDescSchemaVersion is the schema descriptor for schema_version field.
	gatewayinferencerunDescSchemaVersion := gatewayinferencerunFields[7].Descriptor()
	// gatewayinferencerun.SchemaVersionValidator is a validator for the "schema_version" field. It is called by the builders before save.
	gatewayinferencerun.SchemaVersionValidator = func() func(string) error {
		validators := gatewayinferencerunDescSchemaVersion.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// gatewayinferencerunDescProviderRequestID is the schema descriptor for provider_request_id field.
	gatewayinferencerunDescProviderRequestID := gatewayinferencerunFields[9].Descriptor()
	// gatewayinferencerun.ProviderRequestIDValidator is a validator for the "provider_request_id" field. It is called by the builders before save.
	gatewayinferencerun.ProviderRequestIDValidator = gatewayinferencerunDescProviderRequestID.Validators[0].(func(string) error)
	// gatewayinferencerunDescLatencyMs is the schema descriptor for latency_ms field.
	gatewayinferencerunDescLatencyMs := gatewayinferencerunFields[12].Descriptor()
	// gatewayinferencerun.DefaultLatencyMs holds the default value on creation for the latency_ms field.
	gatewayinferencerun.DefaultLatencyMs = gatewayinferencerunDescLatencyMs.Default.(int64)
	// gatewayinferencerunDescCreatedAt is the schema descriptor for created_at field.
	gatewayinferencerunDescCreatedAt := gatewayinferencerunFields[13].Descriptor()
	// gatewayinferencerun.DefaultCreatedAt holds the default value on creation for the created_at field.
	gatewayinferencerun.DefaultCreatedAt = gatewayinferencerunDescCreatedAt.Default.(func() time.Time)
	// gatewayinferencerunDescID is the schema descriptor for id field.
	gatewayinferencerunDescID := gatewayinferencerunFields[0].Descriptor()
	// gatewayinferencerun.DefaultID holds the default value on creation for the id field.
	gatewayinferencerun.DefaultID = gatewayinferencerunDescID.Default.(func() uuid.UUID)
	governanceeventFields := schema.GovernanceEvent{}.Fields()
	_ = governanceeventFields
	// governanceeventDescDeploymentOperatorID is the schema descriptor for deployment_operator_id field.
	governanceeventDescDeploymentOperatorID := governanceeventFields[5].Descriptor()
	// governanceevent.DeploymentOperatorIDValidator is a validator for the "deployment_operator_id" field. It is called by the builders before save.
	governanceevent.DeploymentOperatorIDValidator = governanceeventDescDeploymentOperatorID.Validators[0].(func(string) error)
	// governanceeventDescTargetKind is the schema descriptor for target_kind field.
	governanceeventDescTargetKind := governanceeventFields[6].Descriptor()
	// governanceevent.TargetKindValidator is a validator for the "target_kind" field. It is called by the builders before save.
	governanceevent.TargetKindValidator = governanceeventDescTargetKind.Validators[0].(func(string) error)
	// governanceeventDescTargetID is the schema descriptor for target_id field.
	governanceeventDescTargetID := governanceeventFields[7].Descriptor()
	// governanceevent.TargetIDValidator is a validator for the "target_id" field. It is called by the builders before save.
	governanceevent.TargetIDValidator = governanceeventDescTargetID.Validators[0].(func(string) error)
	// governanceeventDescAction is the schema descriptor for action field.
	governanceeventDescAction := governanceeventFields[8].Descriptor()
	// governanceevent.ActionValidator is a validator for the "action" field. It is called by the builders before save.
	governanceevent.ActionValidator = governanceeventDescAction.Validators[0].(func(string) error)
	// governanceeventDescReason is the schema descriptor for reason field.
	governanceeventDescReason := governanceeventFields[10].Descriptor()
	// governanceevent.ReasonValidator is a validator for the "reason" field. It is called by the builders before save.
	governanceevent.ReasonValidator = governanceeventDescReason.Validators[0].(func(string) error)
	// governanceeventDescRecoveryNonceFingerprint is the schema descriptor for recovery_nonce_fingerprint field.
	governanceeventDescRecoveryNonceFingerprint := governanceeventFields[13].Descriptor()
	// governanceevent.RecoveryNonceFingerprintValidator is a validator for the "recovery_nonce_fingerprint" field. It is called by the builders before save.
	governanceevent.RecoveryNonceFingerprintValidator = governanceeventDescRecoveryNonceFingerprint.Validators[0].(func(string) error)
	// governanceeventDescGatewayRequestID is the schema descriptor for gateway_request_id field.
	governanceeventDescGatewayRequestID := governanceeventFields[14].Descriptor()
	// governanceevent.GatewayRequestIDValidator is a validator for the "gateway_request_id" field. It is called by the builders before save.
	governanceevent.GatewayRequestIDValidator = governanceeventDescGatewayRequestID.Validators[0].(func(string) error)
	// governanceeventDescSafeErrorSummary is the schema descriptor for safe_error_summary field.
	governanceeventDescSafeErrorSummary := governanceeventFields[15].Descriptor()
	// governanceevent.SafeErrorSummaryValidator is a validator for the "safe_error_summary" field. It is called by the builders before save.
	governanceevent.SafeErrorSummaryValidator = governanceeventDescSafeErrorSummary.Validators[0].(func(string) error)
	// governanceeventDescID is the schema descriptor for id field.
	governanceeventDescID := governanceeventFields[0].Descriptor()
	// governanceevent.DefaultID holds the default value on creation for the id field.
	governanceevent.DefaultID = governanceeventDescID.Default.(func() uuid.UUID)
	...
	// modelcatalogentryDescLogicalModel is the schema descriptor for logical_model field.
	modelcatalogentryDescLogicalModel := modelcatalogentryFields[2].Descriptor()
	// modelcatalogentry.LogicalModelValidator is a validator for the "logical_model" field. It is called by the builders before save.
	modelcatalogentry.LogicalModelValidator = modelcatalogentryDescLogicalModel.Validators[0].(func(string) error)
	// modelcatalogentryDescProviderModel is the schema descriptor for provider_model field.
	modelcatalogentryDescProviderModel := modelcatalogentryFields[3].Descriptor()
	// modelcatalogentry.ProviderModelValidator is a validator for the "provider_model" field. It is called by the builders before save.
	modelcatalogentry.ProviderModelValidator = modelcatalogentryDescProviderModel.Validators[0].(func(string) error)
	// modelcatalogentryDescCapabilities is the schema descriptor for capabilities field.
	modelcatalogentryDescCapabilities := modelcatalogentryFields[5].Descriptor()
	// modelcatalogentry.DefaultCapabilities holds the default value on creation for the capabilities field.
	modelcatalogentry.DefaultCapabilities = modelcatalogentryDescCapabilities.Default.([]string)
	// modelcatalogentryDescEmergencyDisabled is the schema descriptor for emergency_disabled field.
	modelcatalogentryDescEmergencyDisabled := modelcatalogentryFields[8].Descriptor()
	// modelcatalogentry.DefaultEmergencyDisabled holds the default value on creation for the emergency_disabled field.
	modelcatalogentry.DefaultEmergencyDisabled = modelcatalogentryDescEmergencyDisabled.Default.(bool)
	// modelcatalogentryDescCreatedAt is the schema descriptor for created_at field.
	modelcatalogentryDescCreatedAt := modelcatalogentryFields[9].Descriptor()
	...
	modelcatalogentryDescUpdatedAt := modelcatalogentryFields[10].Descriptor()
	...
	// modelcatalogentryDescID is the schema descriptor for id field.
	modelcatalogentryDescID := modelcatalogentryFields[0].Descriptor()
	// modelcatalogentry.DefaultID holds the default value on creation for the id field.
	modelcatalogentry.DefaultID = modelcatalogentryDescID.Default.(func() uuid.UUID)
	...
	routedecisionFields := schema.RouteDecision{}.Fields()
	_ = routedecisionFields
	// routedecisionDescProfileVersion is the schema descriptor for profile_version field.
	routedecisionDescProfileVersion := routedecisionFields[4].Descriptor()
	// routedecision.ProfileVersionValidator is a validator for the "profile_version" field. It is called by the builders before save.
	routedecision.ProfileVersionValidator = routedecisionDescProfileVersion.Validators[0].(func(string) error)
	// routedecisionDescRequiredCapabilities is the schema descriptor for required_capabilities field.
	routedecisionDescRequiredCapabilities := routedecisionFields[6].Descriptor()
	// routedecision.DefaultRequiredCapabilities holds the default value on creation for the required_capabilities field.
	routedecision.DefaultRequiredCapabilities = routedecisionDescRequiredCapabilities.Default.([]string)
	// routedecisionDescExplanation is the schema descriptor for explanation field.
	routedecisionDescExplanation := routedecisionFields[9].Descriptor()
	// routedecision.ExplanationValidator is a validator for the "explanation" field. It is called by the builders before save.
	routedecision.ExplanationValidator = routedecisionDescExplanation.Validators[0].(func(string) error)
	// routedecisionDescRuleVersion is the schema descriptor for rule_version field.
	routedecisionDescRuleVersion := routedecisionFields[11].Descriptor()
	// routedecision.RuleVersionValidator is a validator for the "rule_version" field. It is called by the builders before save.
	routedecision.RuleVersionValidator = routedecisionDescRuleVersion.Validators[0].(func(string) error)
	// routedecisionDescClassifierVersion is the schema descriptor for classifier_version field.
	routedecisionDescClassifierVersion := routedecisionFields[13].Descriptor()
	// routedecision.ClassifierVersionValidator is a validator for the "classifier_version" field. It is called by the builders before save.
	routedecision.ClassifierVersionValidator = routedecisionDescClassifierVersion.Validators[0].(func(string) error)
	// routedecisionDescClassifierLatencyMs is the schema descriptor for classifier_latency_ms field.
	routedecisionDescClassifierLatencyMs := routedecisionFields[15].Descriptor()
	// routedecision.DefaultClassifierLatencyMs holds the default value on creation for the classifier_latency_ms field.
	routedecision.DefaultClassifierLatencyMs = routedecisionDescClassifierLatencyMs.Default.(int64)
	// routedecisionDescCandidatePool is the schema descriptor for candidate_pool field.
	routedecisionDescCandidatePool := routedecisionFields[18].Descriptor()
	// routedecision.DefaultCandidatePool holds the default value on creation for the candidate_pool field.
	routedecision.DefaultCandidatePool = routedecisionDescCandidatePool.Default.([]map[string]interface{})
	// routedecisionDescActualLogicalModel is the schema descriptor for actual_logical_model field.
	routedecisionDescActualLogicalModel := routedecisionFields[19].Descriptor()
	// routedecision.ActualLogicalModelValidator is a validator for the "actual_logical_model" field. It is called by the builders before save.
	routedecision.ActualLogicalModelValidator = routedecisionDescActualLogicalModel.Validators[0].(func(string) error)
	// routedecisionDescActualProviderModel is the schema descriptor for actual_provider_model field.
	routedecisionDescActualProviderModel := routedecisionFields[20].Descriptor()
	// routedecision.ActualProviderModelValidator is a validator for the "actual_provider_model" field. It is called by the builders before save.
	routedecision.ActualProviderModelValidator = routedecisionDescActualProviderModel.Validators[0].(func(string) error)
	// routedecisionDescChangeReason is the schema descriptor for change_reason field.
	routedecisionDescChangeReason := routedecisionFields[21].Descriptor()
	// routedecision.ChangeReasonValidator is a validator for the "change_reason" field. It is called by the builders before save.
	routedecision.ChangeReasonValidator = routedecisionDescChangeReason.Validators[0].(func(string) error)
	// routedecisionDescTechnicalRetryCount is the schema descriptor for technical_retry_count field.
	routedecisionDescTechnicalRetryCount := routedecisionFields[22].Descriptor()
	// routedecision.DefaultTechnicalRetryCount holds the default value on creation for the technical_retry_count field.
	routedecision.DefaultTechnicalRetryCount = routedecisionDescTechnicalRetryCount.Default.(int16)
	// routedecisionDescTechnicalRetryReason is the schema descriptor for technical_retry_reason field.
	routedecisionDescTechnicalRetryReason := routedecisionFields[23].Descriptor()
	// routedecision.TechnicalRetryReasonValidator is a validator for the "technical_retry_reason" field. It is called by the builders before save.
	routedecision.TechnicalRetryReasonValidator = routedecisionDescTechnicalRetryReason.Validators[0].(func(string) error)
	// routedecisionDescRoutingLatencyMs is the schema descriptor for routing_latency_ms field.
	routedecisionDescRoutingLatencyMs := routedecisionFields[25].Descriptor()
	// routedecision.DefaultRoutingLatencyMs holds the default value on creation for the routing_latency_ms field.
	routedecision.DefaultRoutingLatencyMs = routedecisionDescRoutingLatencyMs.Default.(int64)
	// routedecisionDescCreatedAt is the schema descriptor for created_at field.
	routedecisionDescCreatedAt := routedecisionFields[26].Descriptor()
	// routedecision.DefaultCreatedAt holds the default value on creation for the created_at field.
	routedecision.DefaultCreatedAt = routedecisionDescCreatedAt.Default.(func() time.Time)
	// routedecisionDescUpdatedAt is the schema descriptor for updated_at field.
	routedecisionDescUpdatedAt := routedecisionFields[27].Descriptor()
	// routedecision.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	routedecision.DefaultUpdatedAt = routedecisionDescUpdatedAt.Default.(func() time.Time)
	// routedecision.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	routedecision.UpdateDefaultUpdatedAt = routedecisionDescUpdatedAt.UpdateDefault.(func() time.Time)
	// routedecisionDescID is the schema descriptor for id field.
	routedecisionDescID := routedecisionFields[0].Descriptor()
	// routedecision.DefaultID holds the default value on creation for the id field.
	routedecision.DefaultID = routedecisionDescID.Default.(func() uuid.UUID)
	...
	superadminseatFields := schema.SuperAdminSeat{}.Fields()
	_ = superadminseatFields
	// superadminseatDescVersion is the schema descriptor for version field.
	superadminseatDescVersion := superadminseatFields[2].Descriptor()
	// superadminseat.DefaultVersion holds the default value on creation for the version field.
	superadminseat.DefaultVersion = superadminseatDescVersion.Default.(int64)
	...
	// userDescSessionVersion is the schema descriptor for session_version field.
	userDescSessionVersion := userFields[3].Descriptor()
	// user.DefaultSessionVersion holds the default value on creation for the session_version field.
	user.DefaultSessionVersion = userDescSessionVersion.Default.(int64)
	...
	_ = worksessionFields
	// worksessionDescTenantID is the schema descriptor for tenant_id field.
	worksessionDescTenantID := worksessionFields[1].Descriptor()
	// worksession.TenantIDValidator is a validator for the "tenant_id" field. It is called by the builders before save.
	worksession.TenantIDValidator = worksessionDescTenantID.Validators[0].(func(string) error)
	// worksessionDescProfileVersion is the schema descriptor for profile_version field.
	worksessionDescProfileVersion := worksessionFields[3].Descriptor()
	// worksession.ProfileVersionValidator is a validator for the "profile_version" field. It is called by the builders before save.
	worksession.ProfileVersionValidator = worksessionDescProfileVersion.Validators[0].(func(string) error)
	// worksessionDescSignalSource is the schema descriptor for signal_source field.
	worksessionDescSignalSource := worksessionFields[4].Descriptor()
	// worksession.SignalSourceValidator is a validator for the "signal_source" field. It is called by the builders before save.
	worksession.SignalSourceValidator = worksessionDescSignalSource.Validators[0].(func(string) error)
	// worksessionDescHmacKeyVersion is the schema descriptor for hmac_key_version field.
	worksessionDescHmacKeyVersion := worksessionFields[7].Descriptor()
	// worksession.HmacKeyVersionValidator is a validator for the "hmac_key_version" field. It is called by the builders before save.
	worksession.HmacKeyVersionValidator = worksessionDescHmacKeyVersion.Validators[0].(func(string) error)
	// worksessionDescAnalysisEligible is the schema descriptor for analysis_eligible field.
	worksessionDescAnalysisEligible := worksessionFields[11].Descriptor()
	// worksession.DefaultAnalysisEligible holds the default value on creation for the analysis_eligible field.
	worksession.DefaultAnalysisEligible = worksessionDescAnalysisEligible.Default.(bool)
	// worksessionDescQuotaGraceEligible is the schema descriptor for quota_grace_eligible field.
	worksessionDescQuotaGraceEligible := worksessionFields[12].Descriptor()
	// worksession.DefaultQuotaGraceEligible holds the default value on creation for the quota_grace_eligible field.
	worksession.DefaultQuotaGraceEligible = worksessionDescQuotaGraceEligible.Default.(bool)
	// worksessionDescSelectedLogicalModel is the schema descriptor for selected_logical_model field.
	worksessionDescSelectedLogicalModel := worksessionFields[14].Descriptor()
	// worksession.SelectedLogicalModelValidator is a validator for the "selected_logical_model" field. It is called by the builders before save.
	worksession.SelectedLogicalModelValidator = worksessionDescSelectedLogicalModel.Validators[0].(func(string) error)
	// worksessionDescRequiredCapabilities is the schema descriptor for required_capabilities field.
	worksessionDescRequiredCapabilities := worksessionFields[17].Descriptor()
	// worksession.DefaultRequiredCapabilities holds the default value on creation for the required_capabilities field.
	worksession.DefaultRequiredCapabilities = worksessionDescRequiredCapabilities.Default.([]string)
	// worksessionDescRoutingVersion is the schema descriptor for routing_version field.
	worksessionDescRoutingVersion := worksessionFields[18].Descriptor()
	// worksession.DefaultRoutingVersion holds the default value on creation for the routing_version field.
	worksession.DefaultRoutingVersion = worksessionDescRoutingVersion.Default.(int64)
	// worksessionDescCreatedAt is the schema descriptor for created_at field.
	worksessionDescCreatedAt := worksessionFields[21].Descriptor()
	...
	// worksessionDescLastActivityAt is the schema descriptor for last_activity_at field.
	worksessionDescLastActivityAt := worksessionFields[22].Descriptor()
	// worksession.DefaultLastActivityAt holds the default value on creation for the last_activity_at field.
	worksession.DefaultLastActivityAt = worksessionDescLastActivityAt.Default.(func() time.Time)
