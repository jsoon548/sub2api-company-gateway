...
func provideCleanup(
	...
	auditManagement *service.AuditManagementService,
) func() {
	return func() {
		...
		parallelSteps := []cleanupStep{
			{"AuditManagementService", func() error {
				if auditManagement != nil {
					auditManagement.Stop()
				}
				return nil
			}},
			{"AuditFoundationService", func() error {
				if auditFoundation != nil {
					auditFoundation.Stop()
				}
				return nil
			}},
