...
func CORS(cfg config.CORSConfig) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if originAllowed {
			...
			c.Writer.Header().Set("Access-Control-Expose-Headers", "ETag, X-Gateway-Request-ID, X-Gateway-Route-Decision-ID, X-Gateway-Actual-Model, X-Gateway-Model-Tier, X-Gateway-Model-Change-Reason")
