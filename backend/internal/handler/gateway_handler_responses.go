...
func (h *GatewayHandler) Responses(c *gin.Context) {
	...
	channelMapping = service.ApplyExplicitModelResolution(requestCtx, reqModel, channelMapping)
	...
	for {
		...
		if err != nil {
			...
			case FailoverContinue:
				service.ApplyAutoRouteResponseHeaders(c.Writer.Header(), requestCtx)
				continue
