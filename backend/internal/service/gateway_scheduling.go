...
func (s *GatewayService) listSchedulableAccounts(ctx context.Context, groupID *int64, platform string, hasForcePlatform bool) ([]Account, bool, error) {
	if s.schedulerSnapshot != nil {
		...
		if err == nil {
			accounts = filterAccountsForExplicitModelResolution(ctx, accounts)
	...
	if useMixed {
		...
		return filterAccountsForExplicitModelResolution(ctx, filtered), useMixed, nil
	}
	...
	return filterAccountsForExplicitModelResolution(ctx, accounts), useMixed, nil
}
...
func (s *GatewayService) getSchedulableAccount(ctx context.Context, accountID int64) (*Account, error) {
	if !explicitModelResolutionAllowsAccount(ctx, accountID) {
		return nil, ErrNoAvailableAccounts
	}
	if s.schedulerSnapshot != nil {
